...
SYSTEM_PROMPT = (
    ...
    "5. If a follow-up is natural, say something like: What else would you like to know? "
    "6. NEVER ask quiz-style questions like: Do you know what models Rahul built? "
